...
def get_all_projects(jwt):
    ...
    url = "https://ivanti.polaris.synopsys.com/api/common/v0/projects?page%5Blimit%5D=500&page%5Boffset%5D=335"
    payload={}
    headers = {
...
if __name__ == '__main__':
    ...
    print(all_projects["data"],len(all_projects["data"]))
    for j in range(len(all_projects["data"])):
        jwt = getJwt(token)
        #print("Generating a new JSON Token",jwt)
